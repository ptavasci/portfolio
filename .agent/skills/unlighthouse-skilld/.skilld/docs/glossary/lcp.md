...
Google recommends achieving an LCP of 2.5 seconds or less for at least 75% of page visits.
...
Run this in your browser console to track LCP in real-time. Based on webperf-snippets.
