...
Interaction to Next Paint measures how quickly your page responds to user interactions. It replaced First Input Delay (FID) as a [Core Web Vital](/glossary) in March 2024 and is now a Google ranking factor.
...
Google recommends an INP of 200 milliseconds or less for at least 75% of page visits.
