...
Google recommends a TTFB of 800 milliseconds or less.
...
- PageSpeed Insights - Shows TTFB in field data
- WebPageTest for detailed waterfall analysis

### Measure in Browser

Run this in your browser console to see TTFB with sub-part breakdown. Based on webperf-snippets.
