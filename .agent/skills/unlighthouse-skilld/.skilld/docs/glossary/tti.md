...
Google removed TTI in Lighthouse 10 because:
...
For most sites, the removal of TTI improved Lighthouse scores since pages typically score better on CLS than they did on TTI.
...
- PageSpeed Insights shows both lab TBT and field INP
