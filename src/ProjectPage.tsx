...
export default function ProjectPage() {
  ...
  const projectTranslation = slug ? t.projectPages?.[slug] : null
  const otherProjects = projectsMeta.filter((p) => p.key !== slug)

  const screenshots = project?.screenshots ?? []

  /* Reset slide when navigating between projects */
      ...
      <div className="flex items-center justify-between mb-10">
        ...
        {project.url !== '#' && (
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-brand-primary text-white text-sm font-medium hover:bg-brand-hover transition-colors"
          >
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-2">
            {projectTranslation.features.map((feature) => (
              <li key={feature} className="flex items-start gap-2 text-zinc-600 dark:text-zinc-400">
        ...
        <div className="space-y-6">
          ...
          {project.url !== '#' && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full px-5 py-3 rounded-xl bg-brand-primary text-white font-medium hover:bg-brand-hover transition-colors"
            >
              {lang === 'es' ? 'Visitar sitio' : 'Visit site'}
            ...
            {otherProjects.map((other) => (
              ...
              >
                ...
                <div className="relative flex items-center justify-between">
                  ...
                  <div className="text-zinc-400 group-hover:text-brand-primary group-hover:translate-x-1 transition-all ml-4 shrink-0">
