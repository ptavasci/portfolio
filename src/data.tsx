import { Code, Server, Shield, Users, Car, Wine, Crown, type LucideIcon } from 'lucide-react'
...
export const skillKeys = ['architecture', 'infra', 'security', 'leadership'] as const
...
export const projectsMeta: ProjectMeta[] = [
  {
    ...
    stack: ['React', 'TypeScript', 'Tailwind CSS', 'Vite', 'Bun', 'Express', 'Supabase', 'PostgreSQL'],
  },
  {
    key: 'vineteca',
    name: 'Vineteca',
    ...
    stack: ['React 19', 'TypeScript', 'Tailwind CSS 4', 'Vite', 'Supabase', 'Zustand', 'TanStack Query', 'Capacitor', 'MercadoPago'],
  },
  {
    key: 'ajedrez',
    name: 'Ajedrez IA',
    ...
    stack: ['React 19', 'TypeScript', 'Tailwind CSS 4', 'LLM', 'chess.js', 'Capacitor', 'Android TV'],
  },
]
...
export const socialLinks = [
  ...
  { name: 'Instagram', url: 'https://www.instagram.com/ptavasci', icon: InstagramIcon },
