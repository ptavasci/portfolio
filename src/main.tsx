  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-6 bg-white dark:bg-bg-dark font-sans">
      ...
      <p className="text-zinc-600 dark:text-zinc-400 mb-8 max-w-md mx-auto">
        Lo sentimos, ha ocurrido un error inesperado. Hemos registrado el
        problema automáticamente y lo revisaremos pronto.
      </p>
      {import.meta.env.DEV && error instanceof Error && (
        <pre className="mb-8 p-4 bg-zinc-100 dark:bg-surface-dark-hover rounded-lg text-left text-xs text-red-500 overflow-auto max-w-full">
          {error.stack}
        </pre>
      )}
      <button
